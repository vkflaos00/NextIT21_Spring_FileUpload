...
public class MemberController {
	...
	public String memberModify(
		...
		try{
			...
			resultMessageVO.failSetting(false, "회원정보 수정  실패", "회원 수정에 실패하였습니다. 전산실에 문의 부탁드립니다. 042-719-8850");
			bne.printStackTrace();
		}catch(BizPasswordNotMatchedException bpn){
			resultMessageVO.failSetting(false, "회원정보 수정  실패", "입력하신 패스워드가 올바르지 않습니다. 다시 입력 부탁드립니다.");
			bpn.printStackTrace();
